...
def home():
    ...
    return render_template('index.html', items=filtered_items or [], slides=slides or [], search_query=query or '')
...
def collection():
    ...
    return render_template('collection.html', items=filtered_items or [], search_query=query or '')
